...
INSERT INTO HeureCours (idModule,idTypeCours,heure, idAnnee) VALUES
	( 3,  1, 6, 1), (1,  1, 65, 1), (2,  1, 28, 1),
	( 3,  2, 0, 1), (1,  2, 30, 1), (2,  2,  0, 1),
	( 3,  3, 0, 1), (1,  3, 15, 1), (2,  3,  7, 1),
	( 3,  4, 0, 1), (1,  4, 15, 1), (2,  4,  7, 1),
	( 3,  5, 0, 1), (1,  5, 31, 1), (2,  5, 14, 1),
	( 3,  6, 0, 1), (1,  6, 38, 1), (2,  6,  0, 1),
	( 3,  7, 0, 1), (1,  7, 24, 1), (2,  7,  0, 1),
	( 3,  8, 6, 1), (1,  8, 23, 1), (2,  8,  0, 1),
	( 3,  9, 0, 1), (1,  9, 22, 1), (2,  9,  0, 1),
	( 3, 10, 0, 1), (1, 10, 16, 1), (2, 10, 14, 1),
	( 3, 11, 0, 1), (1, 11, 17, 1), (2, 11, 15, 1),
	( 3, 12, 0, 1), (1, 12,  7, 1), (2, 12,  7, 1),
	( 3, 13, 4, 1), (1, 13, 62, 1), (2, 13,  0, 1),
	( 3, 14, 0, 1), (1, 14, 51, 1), (2, 14,  0, 1),
	( 3, 15, 0, 1), (1, 15, 25, 1), (2, 15,  0, 1),
	( 3, 16, 0, 1), (1, 16, 10, 1), (2, 16, 12, 1),
	( 3, 17, 0, 1), (1, 17,  2, 1), (2, 17,  6, 1),
	( 3, 18, 0, 1), (1, 18, 34, 1), (2, 18,  0, 1),
	( 3, 19, 0, 1), (1, 19, 31, 1), (2, 19,  0, 1),
	( 3, 20, 0, 1), (1, 20, 15, 1), (2, 20,  0, 1),
	( 3, 21, 0, 1), (1, 21, 42, 1), (2, 21,  0, 1),
	( 3, 22, 0, 1), (1, 22, 38, 1), (2, 22,  0, 1),
	( 3, 23, 0, 1), (1, 23, 15, 1), (2, 23,  0, 1),
	( 3, 24, 0, 1), (1, 24, 14, 1), (2, 24, 14, 1),
	( 3, 25, 0, 1), (1, 25, 21, 1), (2, 25, 13, 1),
	( 3, 26, 0, 1), (1, 26,  8, 1), (2, 26,  8, 1),
	( 3, 27, 0, 1), (1, 27, 34, 1), (2, 27,  0, 1),
	( 3, 28, 0, 1), (1, 28, 41, 1), (2, 28,  0, 1),
	( 3, 29, 2, 1), (1, 29, 10, 1), (2, 29,  0, 1),
	( 3, 30, 0, 1), (1, 30, 42, 1), (2, 30,  0, 1),
	( 3, 31, 7, 1), (1, 31, 21, 1), (2, 31,  0, 1),
	( 3, 32, 0, 1), (1, 32, 19, 1), (2, 32,  0, 1),
	( 3, 33, 3, 1), (1, 33, 32, 1), (2, 33,  0, 1),
	( 3, 34, 0, 1), (1, 34, 34, 1), (2, 34,  0, 1),
	( 3, 35, 0, 1), (1, 35, 22, 1), (2, 35,  0, 1),
	( 3, 36, 0, 1), (1, 36, 32, 1), (2, 36,  0, 1),
	( 3, 37, 7, 1), (1, 37, 17, 1), (2, 37,  0, 1),
	( 3, 38, 0, 1), (1, 38, 20, 1), (2, 38, 13, 1),
	( 3, 39, 0, 1), (1, 39, 20, 1), (2, 39, 13, 1),
	( 3, 40, 0, 1), (1, 40, 16, 1), (2, 40,  0, 1),
	( 3, 41, 0, 1), (1, 41,  0, 1), (2, 41,  0, 1),
	( 3, 42, 7, 1), (1, 42, 29, 1), (2, 42,  0, 1),
	( 3, 43, 0, 1), (1, 43, 18, 1), (2, 43,  0, 1),
	( 3, 44, 0, 1), (1, 44, 20, 1), (2, 44,  0, 1),
	( 3, 45, 0, 1), (1, 45, 15, 1), (2, 45,  0, 1),
	( 3, 46, 0, 1), (1, 46,  9, 1), (2, 46,  9, 1),
	( 3, 47, 0, 1), (1, 47, 11, 1), (2, 47,  9, 1),
	( 3, 48, 0, 1), (1, 48, 10, 1), (2, 48,  0, 1),
	( 3, 49, 0, 1), (1, 49, 24, 1), (2, 49,  0, 1),
	( 3, 50, 0, 1), (1, 50, 11, 1), (2, 50,  0, 1),
	( 3, 51, 5, 1), (1, 51, 20, 1), (2, 51,  0, 1),
	( 3, 52, 8, 1), (1, 52, 22, 1), (2, 52,  0, 1),
	( 3, 53, 0, 1), (1, 53, 15, 1), (2, 53,  0, 1),
	( 3, 54, 0, 1), (1, 54,  0, 1), (2, 54,  0, 1),
	( 3, 55, 0, 1), (1, 55,  0, 1), (2, 55,  0, 1),
	( 3, 56, 0, 1), (1, 56, 13, 1), (2, 56,  0, 1),
	( 3, 57, 0, 1), (1, 57, 10, 1), (2, 57,  0, 1),
	( 3, 58, 0, 1), (1, 58, 15, 1), (2, 58, 15, 1),
	( 3, 59, 0, 1), (1, 59, 15, 1), (2, 59,  0, 1),
	( 3, 60, 0, 1), (1, 60, 36, 1), (2, 60,  0, 1),
	( 3, 61, 0, 1), (1, 61, 15, 1), (2, 61,  0, 1),
	( 3, 62, 0, 1), (1, 62, 15, 1), (2, 62,  0, 1),
	( 3, 63, 0, 1), (1, 63, 22, 1), (2, 63,  0, 1),
	( 3, 64, 0, 1), (1, 64, 20, 1), (2, 64,  0, 1),
	( 3, 65, 0, 1), (1, 65, 35, 1), (2, 65,  0, 1),
	( 3, 66, 0, 1), (1, 66, 12, 1), (2, 66,  0, 1),
	( 3, 67, 0, 1), (1, 67, 35, 1), (2, 67,  0, 1),
	( 3, 68, 0, 1), (1, 68, 15, 1), (2, 68,  0, 1),
	( 3, 69, 0, 1), (1, 69, 15, 1), (2, 69, 10, 1),
	( 3, 70, 0, 1), (1, 70, 12, 1), (2, 70,  0, 1),
	( 3, 71, 0, 1), (1, 71, 12, 1), (2, 71,  0, 1),
	( 3, 72, 0, 1), (1, 72, 10, 1), (2, 72,  0, 1),
	( 3, 73, 0, 1), (1, 73, 10, 1), (2, 73,  0, 1),
	( 3, 74, 0, 1), (1, 74, 24, 1), (2, 74,  0, 1),
	( 3, 75, 0, 1), (1, 75, 18, 1), (2, 75,  0, 1),
	( 3, 76, 0, 1), (1, 76,  0, 1), (2, 76,  0, 1)
	;
