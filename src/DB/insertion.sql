...
INSERT INTO Module (idModule, code, nomModule, idSemestre,idAnnee, idTypeModule ) VALUES
	...
	(13, 'S1.01', 'Implémentation d un besoin client'                           , 1, 1, 2),
	(14, 'S1.02', 'Installation d un poste pour le développement'               , 1, 1, 2),
	(15, 'S1.03', 'Comparaison d approches algorithmiques'                      , 1, 1, 2),
	(16, 'S1.04', 'Création d une base de données'                              , 1, 1, 2),
	(17, 'S1.05', 'Recueil de besoins'                                          , 1, 1, 2),
	(18, 'S1.06', 'Découverte de l environnement économique et écologique'      , 1, 1, 2),
	(19, 'R2.01', 'Développement orienté objets'                                , 2, 1, 3),
	(20, 'R2.02', 'Développement d applications avec IHM'                       , 2, 1, 3),
	(21, 'R2.03', 'Qualité de développement'                                    , 2, 1, 3),
	(22, 'R2.04', 'Communication et fonctionnement bas niveau'                  , 2, 1, 3),
	(23, 'R2.05', 'Introduction aux services réseaux'                           , 2, 1, 3),
	(24, 'R2.06', 'Exploitation d une base de données'                          , 2, 1, 3),
	(25, 'R2.07', 'Graphes'                                                     , 2, 1, 3),
	(26, 'R2.08', 'Outils numériques pour les statistiques'                     , 2, 1, 3),
	(27, 'R2.09', 'Méthodes Numériques'                                         , 2, 1, 3),
	(28, 'R2.10', 'Gestion de projet et des organisations'                      , 2, 1, 3),
	(29, 'R2.11', 'Droit'                                                       , 2, 1, 3),
	(30, 'R2.12', 'Anglais d entreprise'                                        , 2, 1, 3),
	(31, 'R2.13', 'Communication Technique'                                     , 2, 1, 3),
	(32, 'R2.14', 'Projet Professionnel et Personnel'                           , 2, 1, 1),
	(33, 'S2.01', 'Développement d une application'                             , 2, 1, 2),
	(34, 'S2.02', 'Exploration algorithmique d un problème'                     , 2, 1, 2),
	(35, 'S2.03', 'Installation de services réseau'                             , 2, 1, 2),
	(36, 'S2.04', 'Exploitation d une base de données'                          , 2, 1, 2),
	(37, 'S2.05', 'Gestion d un projet'                                         , 2, 1, 2),
	(38, 'S2.06', 'Organisation d un travail d équipe'                          , 2, 1, 2),
	(39, 'R3.01', 'Développement WEB'                                           , 3, 1, 3),
	(40, 'R3.02', 'Développement Efficace'                                      , 3, 1, 3),
	(41, 'R3.03', 'Analyse'                                                     , 3, 1, 3),
	(42, 'R3.04', 'Qualité de développement 3'                                  , 3, 1, 3),
	(43, 'R3.05', 'Programmation Système'                                       , 3, 1, 3),
	(44, 'R3.06', 'Architecture des réseaux'                                    , 3, 1, 3),
	(45, 'R3.07', 'SQL dans un langage de programmation'                        , 3, 1, 3),
	(46, 'R3.08', 'Probabilités'                                                , 3, 1, 3),
	(47, 'R3.09', 'Cryptographie et sécurité'                                   , 3, 1, 3),
	(48, 'R3.10', 'Management des systèmes d information'                       , 3, 1, 3),
	(49, 'R3.11', 'Droits des contrats et du numérique'                         , 3, 1, 3),
	(50, 'R3.12', 'Anglais 3'                                                   , 3, 1, 3),
	(51, 'R3.13', 'Communication professionnelle'                               , 3, 1, 3),
	(52, 'R3.14', 'PPP 3'                                                       , 3, 1, 1),
	(53, 'S3.01', 'Développement d une application'                             , 3, 1, 2),
	(54, 'R4.01', 'Architecture logicielle'                                     , 4, 1, 3),
	(55, 'R4.02', 'Qualité de développement 4'                                  , 4, 1, 3),
	(56, 'R4.03', 'Qualité et au delà du relationnel'                           , 4, 1, 3),
	(57, 'R4.04', 'Méthodes d optimisation'                                     , 4, 1, 3),
	(58, 'R4.05', 'Anglais 4'                                                   , 4, 1, 3),
	(59, 'R4.06', 'Communication interne'                                       , 4, 1, 3),
	(60, 'R4.07', 'PPP 4'                                                       , 4, 1, 1),
	(61, 'R4.08', 'Virtualisation'                                              , 4, 1, 3),
	(62, 'R4.09', 'Management avancé des Systèmesd information'                 , 4, 1, 3),
	(63, 'R4.10', 'Complément web'                                              , 4, 1, 3),
	(64, 'R4.11', 'Développement mobile'                                        , 4, 1, 3),
	(65, 'R4.12', 'Automates'                                                   , 4, 1, 3),
	(66, 'S4.ST', 'Stages'                                                      , 4, 1, 4),
	(67, 'S4.01', 'Développement d une application'                             , 4, 1, 2),
	(68, 'R5.01', 'Initiation au management d une équipe de projet informatique', 5, 1, 3),
	(69, 'R5.02', 'Projet Personnel et Professionnel'                           , 5, 1, 1),
	(70, 'R5.03', 'Politique de communication'                                  , 5, 1, 3),
	(71, 'R5.04', 'Qualité algorithmique'                                       , 5, 1, 3),
	(72, 'R5.05', 'Programmation avancée'                                       , 5, 1, 3),
	(73, 'R5.06', 'Programmation multimédia'                                    , 5, 1, 3),
	(74, 'R5.07', 'Automatisation de la chaîne de production'                   , 5, 1, 3),
	(75, 'R5.08', 'Qualité de développement'                                    , 5, 1, 3),
	(76, 'R5.09', 'Virtualisation avancée'                                      , 5, 1, 3),
	(77, 'R5.10', 'Nouveaux paradigmes de base de données'                      , 5, 1, 3),
	(78, 'R5.11', 'Méthodes d optimisation pour l aide à la décision'           , 5, 1, 3),
	(79, 'R5.12', 'Modélisations mathématiques'                                 , 5, 1, 3),
	(80, 'R5.13', 'Économie durable et numérique'                               , 5, 1, 3),
	(81, 'R5.14', 'Anglais'                                                     , 5, 1, 3),
	(82, 'R6.01', 'Initiation à l entrepreneuriat'                              , 6, 1, 3),
	(83, 'R6.02', 'Droit du numérique et de la propriété intellectuelle'        , 6, 1, 3),
	(84, 'R6.03', 'Communication : organisation et diffusion de l information'  , 6, 1, 3),
	(85, 'R6.04', 'Projet Personnel et Professionnel'                           , 6, 1, 1),
	(86, 'R6.05', 'Développement avancé'                                        , 6, 1, 3),
	(87, 'R6.06', 'Maintenance applicative'                                     , 6, 1, 3),
	(88, 'R6.01', 'Stage'                                                       , 6, 1, 4),
	(89, 'S6.01', 'Évolution d’une application existante'                       , 6, 1, 2)
	;
...
INSERT INTO HeureCours (idTypeCours,idModule,heure,nbSemaine,hParSemaine, idAnnee) VALUES
	...
	(4, 13, 0, 0, 0, 1), (6, 13, 0, 0, 0, 1), (7, 13, 0, 0, 0, 1),
	(4, 14, 0, 0, 0, 1), (6, 14, 0, 0, 0, 1), (7, 14, 0, 0, 0, 1),
	(4, 15, 0, 0, 0, 1), (6, 15, 0, 0, 0, 1), (7, 15, 0, 0, 0, 1),
	(4, 16, 0, 0, 0, 1), (6, 16, 0, 0, 0, 1), (7, 16, 0, 0, 0, 1),
	(4, 17, 0, 0, 0, 1), (6, 17, 0, 0, 0, 1), (7, 17, 0, 0, 0, 1),
	(4, 18, 0, 0, 0, 1), (6, 18, 0, 0, 0, 1), (7, 18, 0, 0, 0, 1),
	...
	(4, 33, 0, 0, 0, 1), (6, 33, 0, 0, 0, 1), (7, 33, 0, 0, 0, 1),
	(4, 34, 0, 0, 0, 1), (6, 34, 0, 0, 0, 1), (7, 34, 0, 0, 0, 1),
	(4, 35, 0, 0, 0, 1), (6, 35, 0, 0, 0, 1), (7, 35, 0, 0, 0, 1),
	(4, 36, 0, 0, 0, 1), (6, 36, 0, 0, 0, 1), (7, 36, 0, 0, 0, 1),
	(4, 37, 0, 0, 0, 1), (6, 37, 0, 0, 0, 1), (7, 37, 0, 0, 0, 1),
	(4, 38, 0, 0, 0, 1), (6, 38, 0, 0, 0, 1), (7, 38, 0, 0, 0, 1),
	...
	(4, 53, 0, 0, 0, 1), (6, 53, 0, 0, 0, 1), (7, 53, 0, 0, 0, 1),
	...
	(4, 66, 0, 0, 0, 1), (5, 66, 0, 0, 0, 1), (7, 66, 0, 0, 0, 1),
	(4, 67, 0, 0, 0, 1), (6, 67, 0, 0, 0, 1), (7, 67, 0, 0, 0, 1),
	...
	(4, 88, 0, 0, 0, 1), (5, 88, 0, 0, 0, 1), (7, 88, 0, 0, 0, 1),
	(4, 89, 0, 0, 0, 1), (6, 89, 0, 0, 0, 1), (7, 89, 0, 0, 0, 1)
	;
